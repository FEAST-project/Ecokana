...
#pragma clang diagnostic pop
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [[[UIAlertView alloc] initWithTitle:[[NSBundle mainBundle]
                                                ...
                                                message:NSLocalizedString(@"カメラへのアクセスは禁止されています。設定アプリで有効にしてください。Access to the camera has been prohibited; please enable it in the Settings app to continue.", nil)
                                               delegate:weakSelf

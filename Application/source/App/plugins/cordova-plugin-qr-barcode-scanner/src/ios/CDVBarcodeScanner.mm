...
- (void)scan:(CDVInvokedUrlCommand*)command {
    ...
    if (capabilityError) {
        ...
        NSString * error = NSLocalizedString(@"カメラへのアクセスは禁止されています。設定アプリで有効にしてください。Access to the camera has been prohibited; please enable it in the Settings app to continue.",nil);
